...
Создание локального репозитория. Чтобы начать работу с локальным репозиторием: Слева в блоке. File Browser выберите каталог, в котором хотите создать репозиторий, и перейдите в него. На верхней панели нажмите *Git* и выберите *Init*.
